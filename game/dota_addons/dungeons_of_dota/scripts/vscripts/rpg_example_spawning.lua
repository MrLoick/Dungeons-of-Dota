...
-- PrecacheSpawners
--------------------------------------------------------------------------------
function CDod:PrecacheSpawners( context )	
...
function CDod:SetupSpawners()
	...
	ListenToGameEvent( "entity_killed", Dynamic_Wrap( CDod, "OnEntityKilled_Spawner" ), self )
end

--------------------------------------------------------------------------------
-- OnEntityKilled_Spawner
--------------------------------------------------------------------------------
function CDod:OnEntityKilled_Spawner( event )
...
--------------------------------------------------------------------------------
function CDod:Think_RespawnCreature( sCreatureName, hSpawner, sState, itemTable )
...
-- SpawnUnit
--------------------------------------------------------------------------------
function CDod:SpawnUnit( sUnitName, nTeam, hSpawner, sUnitState, hInitialWaypoint, bKeepDefaultAcqRng, nMaxDistanceFromSpawner, itemTable )
	...
	local nWaypointSearchRadius = 850
